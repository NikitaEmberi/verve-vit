                            ...
                            <form action="" method="post" class="form">
                                ...
                                <div class="form_item">
                                    <label class="form_input">
                                        <input placeholder="Name" name="name" autocomplete="off" type="text" class="form_input_field"/>
                                        <p class="form_input_field--error"></p>
                                    </label>
                                </div>

                                <div class="form_item">
                                    <label class="form_input">
                                        <input placeholder="E-mail" name="email" autocomplete="off" type="email" class="form_input_field"/>
                                    </label>
                                </div>

                                <div class="form_item">
                                    <label class="form_input">
                                        <input placeholder="Phone" name="phone" autocomplete="off" type="tel" class="form_input_field"/>
                                    </label>
                                </div>
